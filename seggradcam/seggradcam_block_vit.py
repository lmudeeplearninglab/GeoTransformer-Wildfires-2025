...
class SegGradCAM:
    ...
    def featureMapsGradients(self):
        ...
        # conv5_block3_out_output = self.input_model.get_layer('conv5_block3_out').output
        # model_submodel_output = self.input_model.get_layer('model').get_layer('conv2d_15').output
        ...
        print("cpn_output_shape", conv_output.shape)
